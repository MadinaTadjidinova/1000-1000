...
RULES_TEXT = {
    ...
    "menu_dj": "📘 **Джентльмендик келишим / Джентльменское соглашение**\n\n"
            "**[KG]** Ар бир катышуучу 1 жылдык келишимге макул болот жана ай сайын көмөк көрсөтөт. Жыйналган каражаттар китепкананын өнүгүүсүнө жумшалат.\n\n"
            "**[RU]** Каждый участник соглашается с годичным неформальным соглашением и вносит ежемесячную поддержку. Средства идут на развитие библиотеки.",
