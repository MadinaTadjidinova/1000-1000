...
RULES_TEXT = {
    "rule_1": "📘 **1. Общие положения**\n\n"
              "Сообщество спонсоров библиотеки «Дем» создано для её устойчивого развития: финансирования команды и поддержки жизнедеятельности пространства, проведение образовательных, культурных мероприятий и проектов. "
              "Проект «1000/1000» объединяет 1 000 Патронов, каждый из которых ежемесячно вносит от 1 000 сомов на устойчивое развитие библиотеки.",
...
FAQ_TEXT = {
    "faq_1": "💸 Как оплатить?**\n\n"
             "Перейдите в топик 'Стать патроном' или спросите у администратора.",
